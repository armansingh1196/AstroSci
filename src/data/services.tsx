...
export const services = [
  {
    ...
    shortDescription: 'Get a detailed, handwritten Janam Kundli crafted by AstroSci himself — covering life, career, love, health & more.',
    icon: <FileText size={48} color="var(--primary-gold)" />,
  ...
  },
  {
    ...
    icon: <Home size={48} color="var(--primary-gold)" />,
    href: '/services/vastu',
    highlight: false,
  },
  {
    ...
    shortDescription: 'Book a 1-on-1 consultation with AstroSci to get personalized guidance on life decisions, relationships & career.',
    ...
    tiers: [
      {
        ...
        price: 2999,
        originalPrice: 4999,
        description: 'A comprehensive, handwritten Janam Kundli prepared by AstroSci, delivered to your doorstep.',
        features: [
          'Handwritten by AstroSci personally',
          'Complete Janam Kundli analysis',
          'Dasha predictions for 20+ years',
      ...
      },
      {
        ...
        price: 299,
        originalPrice: 599,
        description: 'A concise digital Kundli report with key life predictions, delivered instantly via email.',
        features: [
          'Computer-generated with expert review',
          'Key planetary positions & predictions',
  ...
  vastu: {
    tiers: [
      ...
      },
      {
        ...
        price: 4999,
        originalPrice: 7999,
        description: 'AstroSci visits your home/office in person for a thorough on-site Vastu evaluation.',
        features: [
          'In-person visit by AstroSci',
    ...
    tiers: [
      {
        ...
        price: 999,
        originalPrice: 1499,
        description: 'A 45-minute 1-on-1 video or phone consultation with AstroSci.',
        features: [
          '45-minute session',
          'Video or phone call',
